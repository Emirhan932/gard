...
client.on("guildMemberRemove", async üyecik => {
  ...
  if (logKanali) { logKanali.send(
    ...
    .addField(`Sunucudan Kickleyen Yetkili`,`${yetkili.crison}`)
    .addField(`Yetkiliye Yapılan İşlem`,`Banlanma`)
    .setFooter(`Falco Creative`)
  .setTimestamp())
...
client.on("guildBanAdd", async (guild, üyecik) => {
  ...
  if (!yetkili || !yetkili.executor || guvenli(yetkili.crison.id) || !s.banGuard) return;
   cezalandir(yetkili.executor.id, "ban");
  ...
  if (logKanali) { logKanali.send(
    ...
    .addField(`Sunucudan Banlayan Yetkili`,`${yetkili.crison}`)
    .addField(`Yetkiliye Yapılan İşlem`,`Banlanma`)
    .setFooter(``)
    .setTimestamp()).catch();};
});
...
client.on("guildMemberAdd", async eklenenbotsunsen => {
  ...
  if (!eklenenbotsunsen.user.bot || !yetkili || !yetkili.crison || Date.now()-yetkili.createdTimestamp > 5000 || guvenli(yetkili.executor.id) || !s.botGuard) return;
  cezalandir(yetkili.executor.id, "ban");
...
client.on("guildUpdate", async (oldGuild, newGuild) => {
  ...
  if (logKanali) { logKanali.send(
    ...
    .addField(`Sunucu Ayarlarını Değiştiren Yetkili`,`${yetkili.crison}`)
    .addField(`Yetkiliye Yapılan İşlem`,`Banlanma`)
...
client.on("channelCreate", async channel => {
  ...
  if (logKanali) { logKanali.send(
    ...
    .addField(`Kanalı Oluşturan Yetkili`,`${yetkili.crison}`)
    .addField(`Yetkiliye Yapılan İşlem`,`Banlanma`)
...
client.on("channelUpdate", async (oldChannel, newChannel) => {
  ...
  if (logKanali) { logKanali.send(
    ...
    .addField(`Kanalı Güncelleyen Yetkili`,`${yetkili.crison}`)
    .addField(`Yetkiliye Yapılan İşlem`,`Banlanma`)
...
client.on("channelDelete", async channel => {
  ...
  if (!yetkili || !yetkili.executor || Date.now()-yetkili.createdTimestamp > 5000 || guvenli(yetkili.executor.id) || !s.channelGuard) return;
  cezalandir(yetkili.crison.id, "ban");
  ...
  if (logKanali) { logKanali.send(
    ...
    .addField(`Kanalı Silen Yetkili`,`${yetkili.crison}`)
    .addField(`Yetkiliye Yapılan İşlem`,`Banlanma`)
...
client.on("roleDelete", async role => {
  ...
  if (logKanali) { logKanali.send(
    ...
    .addField(`Rolü Silen Yetkili`,`${yetkili.crison}`)
    .addField(`Yetkiliye Yapılan İşlem`,`Banlanma`)
    .setFooter(``)
    .setTimestamp()).catch(); };
});
...
client.on("guildMemberUpdate", async (oldMember, newMember) => {
  if (newMember.roles.cache.size > oldMember.roles.cache.size) {
    ...
    .setDescription("**__Sağ Tık İle Yönetici Verildi__**")
         ...
         .addField(`Rolü Veren Yetkili`,`${yetkili.crison}`)         
         .addField(`Yetkiliye Yapılan İşlem`,`Banlanma`)
...
client.on("roleCreate", async role => {
  ...
  if (logKanali) { logKanali.send(
    ...
    .addField(`Rolü Açan Yetkili`,`${yetkili.crison}`) 
    .addField(`Yetkiliye Yapılan İşlem`,`Banlanma`) 
